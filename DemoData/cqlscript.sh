...
/opt/dse/bin/dsbulk load -h `hostname -i` -k killr_video -t videos -url /opt/dse/demodata/videos -header false -m "0=video_id,1=avg_rating,2=description,3=genres,4=mpaa_rating,5=release_date,6=release_year,7=title,8=user_id"
