...
/opt/dse/bin/dsbulk load -h `hostname -i` -k killrvideo -t videos_by_actor  -url /opt/dse/demodata/videos_by_actor.csv -header false -m "0=actor_name,1= character_name,2=video_id,3=release_year,4=title"
/opt/dse/bin/dsbulk load -h `hostname -i` -k killrvideo -t videos  -url /opt/dse/demodata/videos -header false -m "0=video_id,avg_rating,1=description,2=genres,3=mpaa_rating,4=release_date,5=release_year,6=title,user_id"
