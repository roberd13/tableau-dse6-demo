...
/opt/dse/bin/dsbulk load -h `hostname -i` -k killr_video -t videos_by_actor -url /opt/dse/demodata/videos_by_actor.csv -header false -maxErrors 1000 -m "0=actor_name,1= character_name,2=video_id,3=release_year,4=title"
/opt/dse/bin/dsbulk load -h `hostname -i` -k killr_video -t videos -url /opt/dse/demodata/videos.csv -header false -maxErrors 1000 -m "0=video_id,1=avg_rating,2=description,3=genres,4=mpaa_rating,5=release_date,6=release_year,7=title,8=user_id"
