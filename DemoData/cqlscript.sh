...
/opt/dse/bin/dsbulk load -h `hostname -i` -k killr_video -t videos -url /opt/dse/demodata/videos -header false -m "0=video_id,avg_rating,1=description,2=genres,3=mpaa_rating,4=release_date,5=release_year,6=title,user_id"
